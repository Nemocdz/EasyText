...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        \("paragraghStyle can set, paragraphSpacing is 2, lineSpacing is 10, alignment is center", .paragrahStyle({
            $0.paragraphSpacing = 2
            $0.alignment = .center
            $0.lineSpacing = 10
        }))
        \("shadow offset is 2 * 2", .shadow({
        ...
        \("underline single and yellow color", .underline(.single, color: .yellow))
        ...
        \("unsupport attributed key can use this", attributesDic: [.ligature : 1])
